...
class WeatherBeanConverter {
  ...
  fun nowWeatherBeanToString(nowWeatherBean: NowWeatherBean): String =
    nowWeatherAdapter.toJson(nowWeatherBean)
  ...
  fun hourlyWeatherToString(list: List<HourlyWeatherBean>): String =
    hourlyWeatherAdapter.toJson(list)

  @TypeConverter
  fun stringToHourly(string: String): List<HourlyWeatherBean> =
    hourlyWeatherAdapter.fromJson(string) ?: listOf()
  ...
  fun stringToMinuties(string: String): List<Minutely> =
    minutelyAdapter.fromJson(string) ?: listOf()

  @TypeConverter
  fun stringToDaily(json: String): List<DailyWeatherBean> =
    dailyWeatherAdapter.fromJson(json) ?: listOf()
  ...
  fun stringToLifeIndex(string: String): List<LifeIndexBean> =
    lifeIndexWeatherAdapter.fromJson(string) ?: listOf()
