...
class DetailsCardsLayout(
    context: Context
) : AViewGroup(context), SpicaWeatherCard {
    ...
    private val feelTempDescCard = DescCardViewLayout(context).apply {
    ...
    private val sunRiseDescCard = DescCardViewLayout(context).apply {
        layoutParams = MarginLayoutParams(
            MarginLayoutParams.MATCH_PARENT, MarginLayoutParams.WRAP_CONTENT
        ).apply {
            topMargin = 12.dp
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        sunRiseDescCard.layout(
            feelTempDescCard.right + 12.dp, humidityDescCard.bottom + sunRiseDescCard.marginTop
        )
    }
