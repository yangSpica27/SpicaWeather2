...
abstract class AViewGroup(
    ...
    protected fun Int.toUnspecifiedMeasureSpec(): Int = MeasureSpec.makeMeasureSpec(this, MeasureSpec.UNSPECIFIED)
    ...
    protected fun View.toHorizontalCenter(parentView: ViewGroup): Int = (parentView.measuredWidth - measuredWidth) / 2

    protected fun View.toVerticalCenter(parentView: ViewGroup): Int = (parentView.measuredHeight - measuredHeight) / 2

    protected fun View.toViewHorizontalCenter(targetView: View): Int = targetView.left - (measuredWidth - targetView.measuredWidth) / 2

    protected fun View.toViewVerticalCenter(targetView: View): Int = targetView.top - (measuredHeight - targetView.measuredHeight) / 2
